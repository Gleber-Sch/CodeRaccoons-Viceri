...
GO
PRINT N'Criando [dbo].[FK_ArquivoMorto_Paciente]...';


GO
ALTER TABLE [dbo].[ArquivoMorto]
    ADD CONSTRAINT [FK_ArquivoMorto_Paciente] FOREIGN KEY ([IdPaciente]) REFERENCES [dbo].[Paciente] ([Id]);
...
GO
PRINT N'Criando [dbo].[PassMorto]...';


GO

CREATE TRIGGER PassMorto ON Paciente
FOR DELETE as
BEGIN
DECLARE @IdPac integer;
SET @IdPac = output.Id
INSERT INTO ArquivoMorto
SELECT Nome, Cpf, Email, DataNasc, Genero, Celular, Id
FROM Paciente
WHERE  Id= @IdPac
INSERT INTO ArquivoMortoHistoricos
SELECT Consulta.Historico, Consulta.IdPaciente
FROM Consulta
WHERE Id = @IdPac
END;
GO
