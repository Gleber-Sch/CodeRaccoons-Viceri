...
CREATE TABLE [dbo].[Consulta] (
    ...
    [IdHorariosConsulta] INT           NOT NULL,
    [IdValorConsulta]    INT           NOT NULL,
...
CREATE TABLE [dbo].[Exame] (
    ...
    [IdHorariosExame] INT NOT NULL,
    [IdValorExame]    INT NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating [dbo].[ValorConsulta]...';
...
GO
PRINT N'Creating [dbo].[ValorExame]...';


GO
CREATE TABLE [dbo].[ValorExame] (
    [Id]          INT   IDENTITY (1, 1) NOT NULL,
    [IdTipoExame] INT   NOT NULL,
    [IdClinica]   INT   NOT NULL,
    [Valor]       MONEY NOT NULL,
...
GO
PRINT N'Creating [dbo].[FK_Consulta_ValorConsulta]...';


GO
ALTER TABLE [dbo].[Consulta]
    ADD CONSTRAINT [FK_Consulta_ValorConsulta] FOREIGN KEY ([IdValorConsulta]) REFERENCES [dbo].[ValorConsulta] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Consulta_HorariosConsulta]...';


GO
ALTER TABLE [dbo].[Consulta]
    ADD CONSTRAINT [FK_Consulta_HorariosConsulta] FOREIGN KEY ([IdHorariosConsulta]) REFERENCES [dbo].[HorariosConsulta] ([Id]);
...
GO
PRINT N'Creating [dbo].[FK_Exame_ValorExame]...';


GO
ALTER TABLE [dbo].[Exame]
    ADD CONSTRAINT [FK_Exame_ValorExame] FOREIGN KEY ([IdValorExame]) REFERENCES [dbo].[ValorExame] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Exame_HorariosExame]...';


GO
ALTER TABLE [dbo].[Exame]
    ADD CONSTRAINT [FK_Exame_HorariosExame] FOREIGN KEY ([IdHorariosExame]) REFERENCES [dbo].[HorariosExame] ([Id]);
