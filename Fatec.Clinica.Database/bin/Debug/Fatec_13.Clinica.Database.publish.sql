...
GO
PRINT N'Criando [dbo].[FK_Clinica_Endereco]...';
...
GO
PRINT N'Criando [dbo].[FK_HorariosExame_Atendimento]...';
...
GO
PRINT N'Criando [dbo].[FK_HorariosExame_TipoExame]...';
...
GO
PRINT N'Criando [dbo].[ViewHorariosConsulta]...';
...
GO
PRINT N'Criando [dbo].[ViewHorariosExame]...';
...
SELECT  He.Id, A.Id AS IdAtendimento, C.Nome AS NomeClinica, M.Nome AS NomeMedico, Tp.Nome, He.Dia, He.Hora, He.Valor
